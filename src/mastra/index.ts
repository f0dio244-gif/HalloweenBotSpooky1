...
// import { pumpkinHuntWorkflow } from "./workflows/pumpkinHunt";
import { initializeDiscordBot } from "./bots/discordBot";
...
export const mastra = new Mastra({
  storage: sharedPostgresStorage as any,
  agents: {},
  workflows: {},
  mcpServers: {
...
// To enable it, ensure DATABASE_URL environment variable is properly set
